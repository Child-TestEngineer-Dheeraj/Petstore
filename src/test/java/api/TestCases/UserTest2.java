...
import api.Endpoints.PetUserEndpoints2;
...
public class UserTest2 {
	...
	{
		Response createRes= PetUserEndpoints2.CreateUser(data);
	...
	{
		Response createRes= PetUserEndpoints2.GetCreatedUser(this.data.getUsername());
		Assert.assertEquals(createRes.getStatusCode(), 200);
	...
	{
		Response createRes= PetUserEndpoints2.LogInCreatedUser(this.data.getUsername(),this.data.getPassword());
		Assert.assertEquals(createRes.getStatusCode(), 200);
